...
export const CALCULATORS: CalculatorData[] = [
  ...
  },
  {
    ...
    keywords: [
      'bmi calculator', 'body mass index calculator', 'bmi calculator for women', 'bmi chart',
      'reverse bmi calculator', 'aarp bmi calculator', 'lean bmi calculator', 'bmi calculator nhs',
      'navy bmi calculator', 'nhs bmi calculator', 'backwards bmi calculator', 'bmi amputation calculator',
      'amazon fire stick users warned about spying bmi calculator app', 'bmi amputee calculator',
      'calculate bmi for amputee', 'cat bmi calculator', 'dog bmi calculator', 'air force bmi calculator',
      'bmi calculator amputation', 'bmi reverse calculation', 'bmi reverse calculator',
      'geriatric bmi calculator', 'black bmi calculator',
      'bmi visualizer', 'underweight icd 10', 'am i fat quiz', 'hip vs waist', 
      'how to measure waist men', '18.5/25', 'adolescence test'
    ],
  ...
  },
  {
    ...
    keywords: [
      'calorie calculator', 'daily calorie calculator', 'maintenance calories', 'calories for weight loss', 'bmr calorie calculator',
      'starbucks calorie calculator', 'subway calorie calculator', 'steps to calories calculator', 'treadmill calorie calculator',
      'dunkin calorie calculator', 'cava calorie calculator', 'panda express calorie calculator', 'calculate starbucks calories',
      'qdoba calorie calculator', 'starbucks calories calculator', 'starbucks drink calorie calculator', 'breastfeeding calorie calculator',
      'calculate chipotle calories', 'calories burned in treadmill calculator', 'chick fil a calorie calculator', 'rucking calorie calculator',
      'subway calories calculator', 'bike calorie calculator', 'calorie calculator qdoba', 'chipotle bowl calories calculator',
      'moes calorie calculator', 'panda calorie calculator', 'calories for breastfeeding calculator', 'hiking calorie calculator',
      'in n out calorie calculator', 'losertown calorie calculator', 'mcdonalds calorie calculator', 'myplate.gov calorie calculator',
      'subway nutrition calories calculator', 'food typing', 'pizzetta calories', 'my pl', 'count-cal', 'salad and go nutrition',
      'how many calories are in a pizza slice', 'how much water should i drink on creatine calculator', 'cal mayo',
      'calories pizza cheese', 'chicken fajitas nutrition information', 'choosemyplate gov', 'grow a garden weight calculator',
      'water fast weight loss calculator', 'calorie cycling', 'calorie of 1 slice pizza', 'how long to lose 50 pounds',
      'how many calories are in a whopper', 'how many calories does 100 jumping jacks burn', 'how many calories is a whopper',
  ...
  },
  {
    ...
    keywords: [
      'tdee calculator', 'total daily energy expenditure', 'macro calculator', 'cutting macros',
      'tdee weight loss calculator', 'tdee calculator reddit', 'bmr calculator tdee', 'calculadora tdee',
      'most accurate tdee calculator', 'reddit tdee calculator', 'tdee accurate calculator', 'legion tdee calculator',
      'tdee calculator lose weight', 'tdee calculator most accurate', 'best tdee calculator reddit', 'tdee calculator formula',
      '1300 calories a day', 'ettd', 'ttee', 'water fasting weight loss calculator', 'weight loss simulator',
      'bmr vs tdee', 'net calories', 'pigly weight loss', 'tdee vs bmr', 'www cal net'
    ],
  ...
  },
  {
    ...
    keywords: [
      'ideal weight calculator', 'healthy weight range', 'what should I weigh', 'ideal body weight',
      'ideal body weight calculation formula', 'adjusted ideal body weight calculator', 'ideal and adjusted body weight calculator',
      'calculate percent ideal body weight', 'ideal running weight calculator', 'ideal body weight calculation pediatrics',
      'ideal runner weight calculator', 'ideal weight for dog calculator', 'bmi visualizer', 'healthy weights for 5\'8 guys',
      '152 lb to kg', '152 pounds to kg', '153 lb to kg', '153 lbs in kg', '158 kg to lbs', '191 pounds in kg',
      '195 lbs in kg', '227 lbs to kg', '27.5 kg lbs', '27.5 pounds to kg', 'meaning weight', '161 lbs kg',
      '161 pounds to kg', '166 lbs in kg', '169 pounds in kg', '183lbs in kg', '215 lbs in kilograms',
      '222 kg to lbs', '222lbs to kg', '227 pounds in kg', '245 pounds to kg', '5.8 kg to lbs', '6.2 kg lbs',
      '65 pounds to us', '88.9 kg to lbs', 'am i fat quiz', 'underweight icd 10'
    ],
  ...
  },
  {
    ...
    keywords: [
      'body fat calculator', 'navy body fat calculator', 'body fat percentage calculator', 'lean body mass calculator',
      'army fitness calculator body fat', 'body fat calculator u.s. navy', 'us navy calculator - body fat calculator',
      'navy percent body fat calculator', 'how to calculate your body fat percentage', 'army body fat percentage calculator',
      'body fat calculator caliper', 'body fat percentage women calculator', 'body fat loss calculator',
      'calipers body fat calculator', 'marine corps body fat calculator', 'new army body fat calculator',
      'body fat percentage 15 percent', 'body composition analyzer', 'army height and weight standards 2025',
      'skinfold calipers', '10 fat percentage', '10 percent of body fat', 'am i fat quiz', 'army acft calculator',
      'hip vs waist', 'how to measure waist men', '10 body fat male', '12 fat percentage', '17 fat body',
      '30 percent body fat', 'army physical test calculator', 'body fat estimate pictures', 'body fat percentage 10',
      'tape measure for body', 'waist measurement men'
    ],
  ...
  },
  {
    ...
    keywords: [
      'pregnancy calculator', 'due date calculator', 'conception calculator', 'ivf due date calculator', 'gestational age calculator',
      'dog pregnancy calculator', 'calculator dog pregnancy', 'pregnancy in dogs calculator', 'canine pregnancy calculator',
      'cow pregnancy calculator', 'cat pregnancy calculator', 'ivf pregnancy due date calculator', 'pregnancy due date calculator nhs',
      'puppy pregnancy calculator', 'when can i do a pregnancy test calculator', 'goat pregnancy calculator', 'cattle pregnancy calculator',
      'feline pregnancy calculator', 'pregnancy calculator ivf', 'period calculator', 'how many weeks is 4 months',
      'how many months is 9 weeks', 'how long is 15 weeks', '27 weeks from today', '40 weeks from now',
      'how can you know when your ovulating', 'how long is 14 weeks', 'how long is 30 weeks', '39 weeks in months',
      '10 weeks ago', '11 months from today', '11 weeks is how many months', 'how long is 22 weeks', 'how long is 7 weeks',
      'menstrual cycle period calculator', 'what is 40 weeks from today', '15 weeks ago', '34 weeks ago from today',
      '40 weeks ago from today', '42 weeks from today', '7 weeks from now', 'calculate next menstrual period',
      'how long is 19 weeks', 'how long is 21 weeks', 'how long is 25 weeks', 'how long is 32 weeks', 'ob wheel',
      'what is 24 weeks from today'
    ],
  ...
  },
  {
    ...
    keywords: [
      'weight converter', 'lbs to kg', 'pounds to kilograms', 'ounces to grams',
      '152 lb to kg', '152 pounds to kg', '153 lb to kg', '153 lbs in kg',
      '191 pounds in kg', '195 lbs in kg', '227 lbs to kg', '27.5 kg lbs',
      '27.5 pounds to kg', '54.5 kg to lbs', '72 kg', '161 lbs kg',
      '161 pounds to kg', '166 lbs in kg', '169 pounds in kg', '215 lbs in kilograms',
      '222 kg to lbs', '222lbs to kg', '227 pounds in kg', '245 pounds to kg',
      '47.5 kilos pounds', '6.2 kg lbs', '65 pounds to us', '68.2 kg to lbs', '88.9 kg to lbs',
      '246 lbs to kg'
    ],
  ...
  },
  {
    ...
    keywords: [
      'dog age calculator', 'cat age calculator', 'dog years to human years', 'cat years to human years', 'pet age converter',
      'math cats age calculator', 'cat age in human years calculator', 'age calculator math cats', 'cat age to human age calculator',
      'cat age calculator in human years', 'how do you calculate a cat\'s age', 'how to calculate cats age', 'dog age calculator app',
      'dog age calculator chart', 'dog age calculator human years', 'age calculator dog', 'age dog calculator',
      'how much sleep do dogs need by age calculator', 'purina dog age calculator', 'small dog age calculator',
      'dog age calculator mixed breed', 'how to calculate dog age in human years', 'dog dog years', '2 years in dog years',
      'how old is 4 in dog years', '10 in dog years', 'how old is a 12 year dog', '12 in dog years', '3 in dog years',
      'how old is 11 in dog years', 'cat age chart', 'cat years in human years', 'cats age in human years',
      'how to tell how old is a cat', 'human years to cat years', 'how old is my kitten', 'cat years to human years'
    ],
  ...
  },
  {
    ...
    keywords: [
      'bac calculator', 'blood alcohol calculator', 'how long to get sober calculator', 'legal driving limit calculator',
      'blood alcohol content calculator', 'blood alcohol content level calculator', 'alcohol blood content calculator',
      'calculate my blood alcohol content', 'calculating blood alcohol content', 'bac level calculator',
      'most accurate bac calculator', 'bac alcohol calculator', 'bac calculator online', 'estimate bac calculator',
      'alcohol bac calculator', 'time to zero bac calculator', 'bac calculator celtic', 'sobriety calculator',
      'drink fox', 'drinkfox', 'sober calculator', '100ml vodak equivalent to beer', 'hennessy alcohol level',
      'how many drinks is 08', '.08 is how many beers', 'how many beers for a .08', 'how many beers in .08',
      'how many white claws to get drunk', '1/5 of alcohol', 'celtic kane bac', 'how does it feel to be drunk',
      'how many beers to .08'
    ],
  ...
  },
  {
    ...
    keywords: [
      'keto macros calculator', 'ketogenic diet calculator', 'low carb macro calculator', 'how much fat on keto',
      'keto macro calculator', 'keto diet macro calculator', 'keto diet calculator macros', 'chipotle macro calculator',
      'ap macro score calculator', 'how do you calculate your macros', 'how to calculate macros for weight loss',
      'precision nutrition macro calculator', 'calculadora de macros', 'ap macro calculator', 'how to calculate your macros for weight loss',
      'how do i calculate macros', 'how to calculate your macros', 'macro calculator for fat loss', 'macros inc calculator',
      'macrs depreciation calculator', 'calculadora keto', 'keto meal calculator', 'mynutrition.com', 'macros for weight loss',
      'body recomp calculator', 'body recomposition calculator', 'ketogenic macronutrient calculator', 'fiber calculator',
      'bulk calculator', 'chick fil a calorie calculator', 'how much water should i drink on creatine calculator',
      'macros for fat loss', 'best app track macros', 'best macros for weight loss female', 'daily water intake calculator',
      'free meal planning app', 'keto diet macros', 'keto food macros', 'macroeconomics calculator', 'best macros for weight loss',
      'calories for breastfeeding calculator', 'how do you track macros', 'how much carbs should i eat to lose weight calculator',
      'in n out calorie calculator', 'macros for muscle gain', 'mcdonald\'s calorie counter', 'mcdonalds calorie calculator',
      'myplate.gov calorie calculator', 'rice calorie counter', 'water fasting weight loss calculator'
    ],
  ...
  },
  {
    ...
    keywords: [
      'ovulation calculator', 'fertility window calculator', 'when am I most fertile', 'period tracker calculator',
      'ivf australia ovulation calculator', 'ovulation calculator first response', 'calculadora de ovulación 100 efectiva',
      'ovulation after miscarriage calculator', 'calculadora de ovulación', 'calculate ovulation with irregular periods',
      'fertilizer calculator', 'calculadora de dias fertiles', 'calculation of total fertility rate',
      'how do you calculate the total fertility rate', 'how to calculate total fertility rate',
      'how to calculate total fertility rate tfr', 'calculadora de fertilidad', 'dias fertiles calculadora',
      'total fertility rate calculation', 'calculadora dias fertiles', 'liquid fertilizer calculator',
      'period calculator', 'when did i conceive', 'pregnancy wheel', 'when did i conceive pregnancy',
      'how do you know when your ovulating', 'when was i conceived', 'how do i know if i\'m ovulating',
      'how do i know when i\'m ovulating', 'reverse due date calculator', 'conception date based on due date',
      'how can you know when your ovulating', 'how to calculate next period date', 'pms cycle calculator',
      'best fertility tracker', 'how do you tell if you are ovulating', 'when will i get my first period quiz',
      'calcule menstruation', 'cycle tracker medical school', 'how do u know when a woman is ovulating',
      'ivf calculator due date', 'ivf transfer due date', 'menses calculator', 'menstrual cycle period calculator',
      'pregnacare', 'when did o conceive', 'when is my next period', 'when is my period due',
      'baby age calculator', 'calculate next menstrual period', 'cycle calculator', 'how long do you ovulate for',
      'how soon do you ovulate after period', 'next menstruation calculator', 'ob wheel',
      'ovulation of irregular menstruation', 'subur', 'when is my next period due',
      'chances of getting pregnant after one time unprotected', 'how long does it take after conception to become pregnant',
      'can you get pregnant while not ovulating', 'can you get pregnant while period',
      'can you get pregnant 2 days after ovulation', 'can you get pregnant when your not ovulating',
      'top rated period tracker app', 'can you conceive day after ovulation'
    ],
  ...
  },
  {
    ...
    keywords: [
      'running pace calculator', 'calculate pace from time and distance', 'marathon pace calculator', 'min per mile calculator',
      'run walk pace calculator', 'mcmillan running pace calculator', 'run walk run pace calculator', 'walk run pace calculator',
      'swim pace calculator', 'treadmill pace calculator', 'atlanta track club pace calculator', 'bike pace calculator',
      'calculating pace zones suunto', 'concept 2 pace calculator', 'erg pace calculator', 'threshold pace calculator',
      'cycling pace calculator', 'grade adjusted pace calculator', 'pace calculator km to miles', 'pace calculator swim',
      'jack daniels pace calculator', 'mcmillan pace calculator', 'pace calculator for walking', 'rowing pace calculator',
      'swimming pace calculator', 'marathon pace chart', 'half marathon pace chart', 'average mile time', '8k to miles',
      '5k pace chart', 'vdot calculator', 'mph calculator', '10k pace chart', 'marathon race km', 'mcmillan running calculator',
      'minute miles to miles per hour', 'pacing for half marathon chart', 'running pace chart', 'time calculator with speed and distance',
      '1600 time', 'pace chart', 'pace chart 10km', 'split calculator', 'vo2 calculator', '6k mile', 'average speed run',
      'half marathon times', 'how many minutes to a mile', 'magic mile', 'marathon pace', 'min/mile to min/km',
      'time calculator distance speed', '1 4 of a mile calculator', '2k in miles', 'calculadora fast', 'half marathon pace',
      'min/km to min/mile', 'pacing running chart', 'running a race', 'running record calculator', 'vdot calc', 'vo2max calculator',
      '2.4km to miles', '3.8 miles in km', '46 km to miles', '5 hour marathon pace', 'concept 2 erg', 'half marathon pacing chart',
      'how many miles is 2k', 'how many miles is 4k', 'mcmillan calculator', 'minutes per mile to mph', 'pace run chart',
      'what is vdot', '1.4 miles km', '1.4 miles to km', '13.1 miles in km', '2 hour marathon pace', '4 min / km in mph',
      '42km in miles', '5k race times', 'average marathon pace', 'average pace in marathon', 'cooper test calculator',
      'daniels running formula', 'half marathon average time', 'how long is a 3k', 'how many miles in a 3k',
      'how many minutes in a mile', 'how many minutes is 10 miles', 'jack daniels running calculator', 'jack daniels vdot',
      'km pace to mile pace', 'marathon 330 pace', 'marathon 5 hours pace', 'min mile to min km', 'min per km to min per mile',
      'minute per mile to minute per kilometer', 'running pacer', 'running vdot calculator', 'speed calculated by distance and time',
      'sub 4 hour marathon pace', 'vdot running calculator'
    ],
